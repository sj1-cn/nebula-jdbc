...
public class UserAutoIncrementJdbcRepositoryTinyAsmWithProxyBuilder {

	public static byte[] dump() throws Exception {

		ClassBody classBody = ClassBuilder
				.make("nebula.data.jdbc.UserAutoIncrementJdbcRepository", Clazz.of(java.lang.Object.class),
						Clazz.of(nebula.data.jdbc.JdbcRepository.class, Clazz.of(nebula.data.jdbc.User.class)))
...

		{
			...
			ColumnList columnList = ctor(ColumnList.class);
			{
				...
				code.STATIC(ColumnDefinition.class, "valueOf").reTurn(ColumnDefinition.class).parameter(String.class).INVOKE();

//				ColumnDefinition cd = refer(code, ColumnDefinition.class);
				columnList.push(refer(code, ColumnDefinition.class));
			}
			{
				code.LINE();
...
//	code.visitLabel(label7OfIFNE);
...

		{
			...
			code.STATIC(Select.class, "columns").reTurn(Select.class).parameter(String.class).INVOKE();
			code.LOADConst("USER");
			code.VIRTUAL(Select.class, "from").reTurn(Select.class).parameter(String.class).INVOKE();
			code.LOAD("start");
			code.VIRTUAL(Select.class, "offset").reTurn(Select.class).parameter(int.class).INVOKE();
			code.LOAD("max");
			code.VIRTUAL(Select.class, "max").reTurn(Select.class).parameter(int.class).INVOKE();
			code.VIRTUAL(Select.class, "toSQL").reTurn(String.class).INVOKE();
			...
			code.GETFIELD("conn", Connection.class);
			code.LOAD("sql");
			code.INTERFACE(Connection.class, "prepareStatement").reTurn(PreparedStatement.class).parameter(String.class).INVOKE();
			code.INTERFACE(PreparedStatement.class, "executeQuery").reTurn(ResultSet.class).INVOKE();
			...
			code.LOAD("resultSet");
			code.VIRTUAL(UserExtendJdbcRowMapper.class, "map").reTurn(UserExtend.class).parameter(ResultSet.class).INVOKE();
			code.INTERFACE(PageList.class, "add").reTurn(boolean.class).parameter(Object.class).INVOKE();
			code.POP();
			...
			code.LINE(51);
			code.LOAD("resultSet");
			code.INTERFACE(ResultSet.class, "next").reTurn(boolean.class).INVOKE();
			...
			code.LOAD("this");
			code.GETFIELD("conn", Connection.class);
			code.INTERFACE(Connection.class, "createStatement").reTurn(Statement.class).INVOKE();
			code.LOAD("sqlCount");
			code.INTERFACE(Statement.class, "executeQuery").reTurn(ResultSet.class).parameter(String.class).INVOKE();
			...
			code.LOAD("resultSetCount");
			code.LOADConst(1);
			code.INTERFACE(ResultSet.class, "getInt").reTurn(int.class).parameter(int.class).INVOKE();
		...
		{
			MethodCode code = classBody.method(Clazz.of(nebula.data.jdbc.PageList.class, Clazz.of(nebula.data.jdbc.User.class)), "listJdbc")
					.tHrow(SQLException.class).parameter("condition", Clazz.of(nebula.data.query.Condition.class))
					.parameter("orderBy", Clazz.of(nebula.data.query.OrderBy.class)).parameter("start", int.class)
			...
			code.VIRTUAL(Select.class, "from").reTurn(Select.class).parameter(String.class).INVOKE();
			code.LOAD("condition");
			code.VIRTUAL(Select.class, "where").reTurn(Select.class).parameter(Condition.class).INVOKE();
			code.LOAD("orderBy");
			code.VIRTUAL(Select.class, "orderby").reTurn(Select.class).parameter(OrderBy.class).INVOKE();
			code.LOAD("start");
			code.VIRTUAL(Select.class, "offset").reTurn(Select.class).parameter(int.class).INVOKE();
			code.LOAD("max");
			code.VIRTUAL(Select.class, "max").reTurn(Select.class).parameter(int.class).INVOKE();
		...
		{
			MethodCode code = classBody.method(ACC_PUBLIC | ACC_VARARGS, User.class, "findByIdJdbc").tHrow(SQLException.class)
			...
			code.LOAD("resultSet");
			code.VIRTUAL(UserExtendJdbcRowMapper.class, "map").reTurn(UserExtend.class).parameter(ResultSet.class).INVOKE();
			code.INTERFACE(List.class, "add").reTurn(boolean.class).parameter(Object.class).INVOKE();
			code.POP();
			...
			code.LOAD("datas");
			code.LOADConst(0);
			code.INTERFACE(List.class, "get").reTurn(Object.class).parameter(int.class).INVOKE();
		...
		{
			MethodCode code = classBody.method(User.class, "insertJdbc").tHrow(SQLException.class).parameter("data", User.class).begin();
			...
			code.LOADConst(1);
			code.INTERFACE(Connection.class, "prepareStatement").reTurn(PreparedStatement.class).parameter(String.class)
			...
			code.LOADConst(1);
			code.LOAD("data");
			code.VIRTUAL(User.class, "getName").reTurn(String.class).INVOKE();
			code.INTERFACE(PreparedStatement.class, "setString").parameter(int.class).parameter(String.class).INVOKE();

			code.LINE(123);
			code.LOAD("preparedStatement");
			code.LOADConst(2);
			code.LOAD("data");
			code.VIRTUAL(User.class, "getDescription").reTurn(String.class).INVOKE();
			code.INTERFACE(PreparedStatement.class, "setString").parameter(int.class).parameter(String.class).INVOKE();
			...
			code.LOAD("preparedStatement");
			code.LOADConst(3);
			code.VIRTUAL("bindInsertExtend").reTurn(int.class).parameter(PreparedStatement.class).parameter(int.class).INVOKE();
			code.POP();

			code.LINE(127);
			code.LOAD("preparedStatement");
			code.INTERFACE(PreparedStatement.class, "executeUpdate").reTurn(int.class).INVOKE();
			Label label7OfIFLE = new Label();
			code.IFLE(label7OfIFLE);

			code.LINE(128);
			code.LOAD("preparedStatement");
			code.INTERFACE(PreparedStatement.class, "getGeneratedKeys").reTurn(ResultSet.class).INVOKE();
			code.STORE("rs");
			...
			code.LOAD("rs");
			code.LOADConst(1);
			code.INTERFACE(ResultSet.class, "getLong").reTurn(long.class).parameter(int.class).INVOKE();
			code.STATIC(Long.class, "valueOf").reTurn(Long.class).parameter(long.class).INVOKE();
			code.ARRAYSTORE();
			code.VIRTUAL("findByIdJdbc").reTurn(User.class).parameter(Object[].class).INVOKE();
			code.RETURNTop();
		...
		{
			MethodCode code = classBody.method(User.class, "updateJdbc").tHrow(SQLException.class).parameter("data", User.class).begin();
			...
			code.LOADConst(0);
			code.LOAD("data");
			code.VIRTUAL(User.class, "getId").reTurn(long.class).INVOKE();
			code.STATIC(Long.class, "valueOf").reTurn(Long.class).parameter(long.class).INVOKE();
			code.ARRAYSTORE();
			code.VIRTUAL("findByIdJdbc").reTurn(User.class).parameter(Object[].class).INVOKE();
			...
			code.LINE(140);
			code.LOAD("extend");
			code.INTERFACE(ClassExtend.class, "getUpdateAt").reTurn(Timestamp.class).INVOKE();
			code.LOAD("data");
			code.CHECKCAST(ClassExtend.class);
			code.INTERFACE(ClassExtend.class, "getUpdateAt").reTurn(Timestamp.class).INVOKE();
			...
			code.LOAD("preparedStatement");
			code.LOADConst(3);
			code.VIRTUAL("bindUpdateExtend").reTurn(int.class).parameter(PreparedStatement.class).parameter(int.class).INVOKE();
			code.POP();
		...
		{
			MethodCode code = classBody.method(ACC_PUBLIC | ACC_VARARGS, int.class, "deleteJdbc").tHrow(SQLException.class)
					.parameter("keys", Object[].class).begin();
...

		{
			MethodCode code = classBody.method(ACC_PUBLIC | ACC_BRIDGE | ACC_VARARGS | ACC_SYNTHETIC, Object.class, "findByIdJdbc")
					.tHrow(SQLException.class).parameter("var1", Object[].class).begin();
...

		{
			...
			code.LOAD("var1");
			code.CHECKCAST(User.class);
			code.VIRTUAL("updateJdbc").reTurn(User.class).parameter(User.class).INVOKE();
			code.RETURNTop();
			code.END();
		}

		{
			...
			code.LOAD("var1");
			code.CHECKCAST(User.class);
			code.VIRTUAL("insertJdbc").reTurn(User.class).parameter(User.class).INVOKE();
			code.RETURNTop();
			code.END();
		}
