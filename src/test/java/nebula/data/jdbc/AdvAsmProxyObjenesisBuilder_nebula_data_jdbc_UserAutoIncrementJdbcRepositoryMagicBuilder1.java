...
import nebula.data.jdbc.UserAutoIncrementJdbcRepositoryMagicBuilder;
import nebula.data.query.Condition;
import nebula.data.query.OrderBy;

public class AdvAsmProxyObjenesisBuilder_nebula_data_jdbc_UserAutoIncrementJdbcRepositoryMagicBuilder1 extends UserAutoIncrementJdbcRepositoryMagicBuilder implements AdvRuntimeReferNameObject {
	 private byte _magicNumber;
	  ...
	  public <T, D> List<T> list_(Class<D> param0) {
	    AdvContext context = this._contextThreadLocal.get();
	    ConsumerWithException<MethodCode> eval_param0 = context.resolve(param0);
	    ConsumerWithException<MethodCode> objEval = context.resolve(this);
	    byte codeIndex = context.push(List.class, c -> {
	          objEval.accept(c);
	          eval_param0.accept(c);
	          c.VIRTUAL(UserAutoIncrementJdbcRepositoryMagicBuilder.class, "list_").parameter(Class.class).return_(List.class).INVOKE();
	        });
	    byte magicNumber = (byte)(80 + codeIndex);
	    return null;
	  }
