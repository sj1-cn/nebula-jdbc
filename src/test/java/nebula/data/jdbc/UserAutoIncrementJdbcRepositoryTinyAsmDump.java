...
ClassBody classWriter = ClassBuilder.make("nebula.data.jdbc.UserAutoIncrementJdbcRepository", Clazz.of(java.lang.Object.class),Clazz.of(nebula.data.jdbc.JdbcRepository.class,Clazz.of(nebula.data.jdbc.User.class))).access(ACC_PUBLIC | ACC_SUPER).body();
