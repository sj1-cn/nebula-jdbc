...
public class RepositoryFactoryTest extends TestBase {
	...
	public void test_getUserComplexRepository() {
		...
		UserComplex b = new UserComplex(2, "name_b20", new BigDecimal(20000), false, 'B', (byte) 251, (short) 2601,
				2701, 2801L, 290.1F, 2100.1D, new Date(21100), new Time(21200), new Timestamp(21300));
		UserComplex b2 = new UserComplex(2, "name_b30", new BigDecimal(30000), false, 'C', (byte) 351, (short) 3601,
...
//		UserMoreComplex a = new UserMoreComplex(1, "name_b20", null, null, null, null, null, null, null, null, null, null, null, null);
		...
		UserMoreComplex a = new UserMoreComplex(1L, "name_a10", new BigDecimal(10000), false, 'A', (byte) 51,
				(short) 601, 701, 801L, 90.1F, 100.1D, new Date(1100), new Time(1200), new Timestamp(1300));

		UserMoreComplex b = new UserMoreComplex(2L, "name_b20", new BigDecimal(20000), false, 'B', (byte) 251,
				(short) 2601, 2701, 2801L, 290.1F, 2100.1D, new Date(21100), new Time(21200), new Timestamp(21300));
		UserMoreComplex b2 = new UserMoreComplex(2L, "name_b30", new BigDecimal(30000), false, 'C', (byte) 351,
