...
public class TinyAsmJdbcRepositoryBuilderTinyASMifierTest {
	...
	public void test_UserJdbcRepository_build() throws Exception {
		...
		clazzFields.push(new PersistentProperty(true, "id", "getId", long.class, new ColumnDefinition("id", INTEGER)));
		...
		PersistentEntity entityDefinition = new PersistentEntity(User.class.getSimpleName(), User.class.getName(), User.class.getSimpleName(), clazzFields);
	...
	public void test_UserAutoIncrementJdbcRepository_build() throws Exception {
		...
		FieldList clazzFields = new FieldList();
		clazzFields.push(new PersistentProperty(true, "id", "getId", long.class, INTEGER("id").primarykey().autoIncrement()));
